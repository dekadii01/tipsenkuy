            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                    ...
                    <div class="p-6 flex flex-col items-center gap-4 text-center">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <span
                                class="mx-auto mt-1 text-[0.65rem] font-light tracking-widest uppercase text-blue-800 bg-blue-50 border border-blue-200 rounded-full px-3 py-1">
                                Participant
                            </span>
                        </div>
                        ...
                        <div class="w-full grid grid-cols-3 gap-2">
                            ...
                            <div class="flex flex-col items-center gap-0.5 border-x border-gray-100">
                                <p class="text-base font-light text-gray-900">18</p>
                                <p class="text-[0.62rem] font-light text-gray-400 leading-tight text-center">
                                    Hadir<br>bulan ini</p>
                            </div>
                            <div class="flex flex-col items-center gap-0.5">
                                <p class="text-base font-light text-gray-900">96%</p>
                                <p class="text-[0.62rem] font-light text-gray-400 leading-tight text-center">
                                    Tingkat<br>hadir</p>
                            </div>
                        </div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                    @foreach ([['Informasi Pribadi', 'M3 7h18M3 12h18M3 17h18', '#info', true], ['Keamanan', 'M12 2a4 4 0 0 1 4 4v2H8V6a4 4 0 0 1 4-4zM4 12h16v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8z', '#security', false], ['Notifikasi', 'M8 2a5 5 0 0 0-5 5v2.5L2 11h12l-1-1.5V7a5 5 0 0 0-5-5zM6.5 13a1.5 1.5 0 0 0 3 0', '#notif', false]] as [$label, $icon, $href, $active])
                        <a href="{{ $href }}" @class([
                            'flex items-center gap-3 px-5 py-3.5 text-sm transition-colors no-underline border-b border-gray-100 last:border-0',
                            ...
                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                                @class(['text-blue-900' => $active, 'text-gray-400' => !$active])>
                                <path d="{{ $icon }}" stroke="currentColor" stroke-width="1.5"
            ...
            <div class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div id="info" class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                    ...
                    <div class="px-7 py-5 border-b border-gray-100">
                        ...
                        <p class="text-[0.72rem] font-light text-gray-400 mt-0.5">Perbarui nama dan informasi dasar kamu
                        </p>
                    </div>
                    ...
                    <form method="POST" action="" class="px-7 py-6 flex flex-col gap-5">
                        ...
                        {{-- <div class="flex flex-col gap-2">
                            ...
                            <input id="nim" type="text" name="nim"
                                value="{{ old('nim', auth()->user()->nim ?? '') }}" placeholder="Contoh: 2021001234"
                                class="w-full px-4 py-2.5 text-sm font-light text-gray-900 bg-gray-50 border border-gray-200 rounded-xl placeholder-gray-300 focus:outline-none focus:border-blue-300 focus:bg-white focus:ring-2 focus:ring-blue-100 transition-all duration-200">
                            @error('nim')
                                <p class="text-[0.72rem] font-light text-red-500">{{ $message }}</p>
                            @enderror
                ...
                <div id="notif" class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                    ...
                    <div class="px-7 py-5 border-b border-gray-100">
                        <h2 class="text-sm font-medium text-gray-900">Notifikasi</h2>
                        <p class="text-[0.72rem] font-light text-gray-400 mt-0.5">Atur preferensi notifikasi kamu</p>
                    </div>

                    <div class="px-7 py-6 flex flex-col gap-4">

                        @foreach ([['Pengingat sesi', 'Ingatkan saya sebelum sesi dimulai', 'reminder_session', true], ['Konfirmasi absensi', 'Notifikasi setelah berhasil scan QR', 'confirm_scan', true], ['Sesi akan berakhir', 'Ingatkan jika waktu absen hampir habis', 'session_ending', false], ['Rekap mingguan', 'Kirim ringkasan kehadiran setiap minggu', 'weekly_recap', false]] as [$title, $desc, $name, $checked])
                            <div
